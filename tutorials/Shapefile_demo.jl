...
# ╔═╡ cbdf515d-2289-4fcc-b411-2d2a6466e752
begin
	import Shapefile, Rasters, Plots
	using PlutoUI, Dataverse
end

# ╔═╡ ad6a4770-1d20-45fb-bc6b-fc35708912da
md"""# Shapefile example

For information on the data see links below.

- DOI : <https://doi.org/10.14284/382>
- URL <https://www.vliz.be/en/imis?dasid=6315&doiid=382>
- source : <https://marineregions.org/sources.php>

"""

# ╔═╡ 67d4bf40-3d17-4193-bdf1-8759f0688f29
@bind fil0 Select(["Longhurst_world_v4_2010.shp","eez_v11.shp"])
	#"polygons_etc/longhurst_v4_2010/Longhurst_world_v4_2010.shp",
	#"polygons_etc/ICES_ecoregions/ICES_ecoregions_20171207_erase_ESRI.shp",
	#"polygons_etc/Intersect_EEZ_IHO_v4_2020/Intersect_EEZ_IHO_v4_2020.shp",
	#"Maritime_Boundaries_v11/World_ECS_v1_20221013/ecs_v01.shp",
	#"Maritime_Boundaries_v11/World_Archipelagic_Waters_v3_20191118/eez_archipelagic_waters_v3.shp",
	#"Maritime_Boundaries_v11/World_High_Seas_v1_20200826/High_Seas_v1.shp",
	#"Maritime_Boundaries_v11/World_EEZ_v11_20191118/eez_v11.shp",
	#"Maritime_Boundaries_v11/World_Internal_Waters_v3_20191118/eez_internal_waters_v3.shp",
	#])

# ╔═╡ b03a2a2e-a8d4-4f87-bc40-fc4cedd1971d
begin
...
# ╔═╡ 1fcebd03-816f-4398-b132-441d61ac3480
begin
	pth0=joinpath(tempdir(),"polygons_tmp1")
	filenames=["polygons_EEZ.geojson","Longhurst_world_v4_2010.shp","eez_v11.shp"]
...
# ╔═╡ ccc35ac2-407a-4718-9742-a7c788cc129f
begin
	shapes = Shapefile.Handle(joinpath(pth0,fil0))
	a=Plots.plot(shapes.shapes)
end
...
manifest_format = "2.0"
project_hash = "557108ef411798393250cb1912374e0fff4a9224"
...
git-tree-sha1 = "23f5c980109b4c3708d5c754f2f13cad38215e90"
uuid = "3cb90ccd-e1b6-4867-9617-4276c8b2ca36"
version = "0.5.7"

[[deps.Rasters]]
deps = ["Adapt", "ArchGDAL", "ColorTypes", "ConstructionBase", "CoordinateTransformations", "Dates", "DimensionalData", "DiskArrays", "Extents", "FillArrays", "Flatten", "GeoFormatTypes", "GeoInterface", "HDF5", "MakieCore", "Missings", "Mmap", "NCDatasets", "OffsetArrays", "ProgressMeter", "RasterDataSources", "RecipesBase", "Reexport", "Requires", "Setfield"]
git-tree-sha1 = "6ffe578313b95a21fb6eaeb0f4210b4a2b6d4882"
