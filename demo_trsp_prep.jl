...
function trsp_read(mygrid::gcmgrid,dirIn::String)
    ...
    TrspX=mygrid.read(dirIn*"TrspX.bin",gcmfaces(mygrid,Float32))
    TrspY=mygrid.read(dirIn*"TrspY.bin",gcmfaces(mygrid,Float32))
    TauX=mygrid.read(dirIn*"TauX.bin",gcmfaces(mygrid,Float32))
    TauY=mygrid.read(dirIn*"TauY.bin",gcmfaces(mygrid,Float32))
    SSH=mygrid.read(dirIn*"SSH.bin",gcmfaces(mygrid,Float32))
