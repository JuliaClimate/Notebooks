...
This series of [Julia](https://julialang.org) / [Pluto.jl](https://plutojl.org) notebooks is a demo of [JuliaClimate](https://github.com/JuliaClimate/) packages working in concert together and within the broader `Julia` package ecosystem. You can replay the notebooks on your computer or in the cloud (see [User Directions](#directions)).
...
These examples provide code that reads from NetCDF, Zarr, and CSV files.
...
The [OceanStateEstimation.jl](https://github.com/gaelforget/OceanStateEstimation.jl) and [MeshArrays.jl](https://github.com/JuliaClimate/MeshArrays.jl) packages deal with gridded variables. 

This is the case of climatologies, reanalyses, and other gridded data products.
...
The [OceanRobots.jl](https://github.com/gaelforget/OceanRobots.jl) and [ArgoData.jl](https://github.com/JuliaOcean/ArgoData.jl) packages deal with data generated by scientific robots in the Ocean. 

The examples cover common file formats and various access protocols (http, ftp, opendap, thredds). 
...
\lead{MIT general circulation model}
...
\begin{section}{title="More Examples",name="More"}
...
- [xarray\_climarray\_etc.jl](xarray_climarray_etc.html) ([notebook url](https://raw.githubusercontent.com/JuliaClimate/Notebooks/master/tutorials/xarray_climarray_etc.jl)) uses Python's xarray and related Julia packages.
