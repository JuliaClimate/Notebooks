...
This page provides a series of [Julia](https://julialang.org) / [Pluto.jl](https://plutojl.org) notebooks which illustrate [JuliaClimate](https://github.com/JuliaClimate/) packages in action.

You can replay the notebooks on your computer or in the cloud (see [User Directions](#directions)).

A selection of images generated by the notebooks is shown just below.
...
The maps, histograms, and other graphs shown in [this page](#sample-viz) were created with [Makie.jl](https://makie.juliaplots.org/stable/) and [Plots.jl](http://docs.juliaplots.org/latest/). 
